            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <p className="text-foreground">
                  <span className="font-semibold">Aliados de Inter Rapidísimo</span> - Envíos seguros a toda Colombia
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-6 w-6 text-primary shrink-0 mt-0.5" />
                <p className="text-foreground">
                  <span className="font-semibold">Atención personalizada</span> - Somos tu negocio de confianza en Dagua
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-6 w-6 text-primary shrink-0 mt-0.5" />
