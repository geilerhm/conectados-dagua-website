    ...
    <footer className="bg-foreground text-background py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-background/80 text-sm leading-relaxed">
              Tu aliado local en {BUSINESS_INFO.address.city} para envíos, servicios de oficina, impresiones y más.
        ...
        <div className="pt-8 border-t border-background/20 text-center text-sm text-background/70">
          <p>© {currentYear} {BUSINESS_INFO.name} - {BUSINESS_INFO.legalName}. Todos los derechos reservados.</p>
          <p className="mt-2">
